...
export default class Application extends Component {
    ...
    getApplications = async (currentPage) => {
        ...
        if (verifyCode && isNaN(verifyCode)) {
            ...
            message.warn('verifyCode must be a integer')
            return
        }

        let result;
        if (searchAddress !== '全部' || verifyCode) {
    ...
    render() {
        ...
        const title = (
            <span>
                ...
                />
                <Button type='primary' onClick={() => this.getApplications(1)}>搜索</Button>
            </span>
        )
